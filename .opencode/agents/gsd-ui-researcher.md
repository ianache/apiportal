...
Use template from `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
