...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done
                  → writes to D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
