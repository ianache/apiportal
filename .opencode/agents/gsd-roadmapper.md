...
Reference full template: `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/templates/state.md`.
