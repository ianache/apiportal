...
API_KEY=placeholder
NEXT_PUBLIC_API_URL=http://localhost:3001  # Still pointing to localhost in prod
```
...
**@D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/references/checkpoints.md** → `<automation_reference>` section
