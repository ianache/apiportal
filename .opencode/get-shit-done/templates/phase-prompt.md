...
<!-- For checkpoint task examples and patterns, see @D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/references/checkpoints.md -->
...
See `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/02-PERSONAL/01-PROJECTS/21-APIManager/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
